...
public record SyncVisitedBiomesPayload(Set<ResourceLocation> visitedBiomes) implements CustomPacketPayload {
    public static final CustomPacketPayload.Type<SyncVisitedBiomesPayload> TYPE = new CustomPacketPayload.Type<SyncVisitedBiomesPayload>(ResourceLocation.fromNamespaceAndPath("quantum_quarry", "sync_visited_biomes"));
